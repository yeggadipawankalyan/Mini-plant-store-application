...
async function fixAllPlantImages() {
    try {
        console.log('🖼️ Fixing all plant images with working URLs...');
        
        // Working, reliable image URLs for each plant type
        const imageUpdates = [
            {
                name: 'Snake Plant',
...
module.exports = { fixAllPlantImages };
